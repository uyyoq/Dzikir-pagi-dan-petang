...
import { ListPetang } from "../DataList/listPetang";
    ...
    <div className="">
      ...
      >
        <div className="flex flex-wrap mx-auto justify-center">
          <SwiperSlide>
            <div className="justify-center w-full lg:w-5/12 mx-auto pb-10 px-5 md:px-10 m-14 md:shadow-xl md:rounded">
          ...
          <SwiperSlide>
            <div className="justify-center w-full lg:w-8/12 mx-auto pb-10 px-5 md:px-10 md:shadow-xl md:rounded">
              <p className="font-JosefinSans font-bold font-xl text-gray-800 pb-3 uppercase">
