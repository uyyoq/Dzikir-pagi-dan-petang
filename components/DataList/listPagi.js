export const ListPagi = [
  {
    ...
    latin: ` "Allohu laa ilaaha illaa Huwal Hayyul Qoyyuum, laa ta’khudzuhuu
  ...
  },
  {
    ...
    classNameLatin:
      "p-3 font-Montserrat text-xs md:text-sm tracking-wide leading-7",
    latin:
      "Ash-bahnaa wa ash-bahal mulku lillah walhamdulillah, laa ilahaillallah wahdahu laa syarika lah, lahul mulku walahul hamdu wa huwa ‘ala kulli syai-in qodir. Robbi as-aluka khoiro maa fii hadzal yaumi wa khoiro maa ba’dahu, wa a’udzu bika min syarri maa fii hadzal yaum wa syarri maa ba’dahu. Robbi a’udzu bika minalkasali wa su-il kibar. Robbi a’udzu bika min ‘adzabin fin naariwa ‘adzabin fil qobri.",
    classNameCardArti:
      "shadow rounded bg-gray-100 border-l-8 border-gray-300 p-5 m-5 mx-auto text-left",
    classNameArtinya:
      "pb-3 font-semibold text-gray-900 font-mono text-sm md:text-base",
  ...
  },
  {
    ...
    classNameLatin:
      "p-3 font-Montserrat text-xs md:text-sm tracking-wide leading-7",
    latin:
      " Allahumma bika ash-bahnaa wa bika amsaynaa wa bika nahyaa wabika namuutu wa ilaikan nusyuur.",
    classNameCardArti:
      "shadow rounded bg-gray-100 border-l-8 border-gray-300 p-5 m-5 mx-auto text-left",
    classNameArtinya:
      "pb-3 font-semibold text-gray-900 font-mono text-sm md:text-base",
  ...
  },
  {
    ...
    classNameLatin:
      "p-3 font-Montserrat text-xs md:text-sm tracking-wide leading-7",
    latin: `Allahumma inni ash-bahtu usy-hiduka wa usy-hidu hamalata
  ...
  },
  {
    ...
    classNameLatin:
      "p-3 font-Montserrat text-xs md:text-sm tracking-wide leading-7",
    latin:
      " Yaa Hayyu Yaa Qoyyum, bi-rohmatika as-taghiits, wa ash-lih lii sya’nii kullahu wa laa takilnii ilaa nafsii thorfata.",
    classNameCardArti:
      "shadow rounded bg-gray-100 border-l-8 border-gray-300 p-5 m-5 mx-auto text-left",
    classNameArtinya:
      "pb-3 font-semibold text-gray-900 font-mono text-sm md:text-base",
  ...
  },
  {
    ...
    classNameCardFaedah:
      "border-r-2 border-b-4 bg-blue-100 border-blue-300 m-4 p-5 shadow rounded md:w-8/12 mx-auto",
    classNameFaedahtitle: "pb-3 font-MarckScript text-base md:text-lg",
    faedahnya: ` Barangsiapa yang mengucapkan kalimat ‘subhanallah wa bi
  ...
  },
  {
    ...
    classNameLatin:
      "p-3 font-Montserrat text-xs md:text-sm tracking-wide leading-7",
    latin: ` Laa ilaha illallah wahdahu laa syarika lah, lahul mulku walahul
  ...
  },
  {
    ...
    classNameCardFaedah:
      "border-r-2 border-b-4 bg-blue-100 border-blue-300 m-4 p-5 shadow rounded md:w-9/12 mx-auto",
    classNameFaedahtitle: "pb-3 font-MarckScript text-base md:text-lg",
    faedahnya: `  Barangsiapa yang mengucapkan dzikir tersebut dalam sehari
  ...
  },
  {
    ...
    classNameLatin:
      "p-3 font-Montserrat text-xs md:text-sm tracking-wide leading-7",
    latin: ` Subhanallah wa bi-hamdih, ‘adada kholqih wa ridhoo nafsih. wa
