export const ListTidur = [
  ...
  },
  {
    ...
    classNameLatin:
      "p-3 font-Montserrat text-xs md:text-sm tracking-wide leading-7",
    latin: `aamanar-rosuulu bimaaa unzila ilaihi mir robbihii wal-mu'minuun, kullun aamana billaahi wa malaaa'ikatihii wa kutubihii wa rusulih, 
            laa nufarriqu baina ahadim mir rusulih, wa qooluu sami'naa wa atho'naa ghufroonaka robbanaa wa ilaikal-mashiir . 
            laa yukallifullohu nafsan illaa wus'ahaa, lahaa maa kasabat wa 'alaihaa maktasabat, robbanaa laa tu'aakhiznaaa in nasiinaaa au akhtho'
            naa, robbanaa wa laa tahmil 'alainaaa ishrong kamaa hamaltahuu 'alallaziina ming qoblinaa, robbanaa wa laa tuhammilnaa maa laa thooqota lanaa bih,
            wa'fu 'annaa, waghfir lanaa, war-hamnaa, anta maulaanaa fanshurnaa 'alal-qoumil-kaafiriin.`,
    classNameCardArti:
      "shadow rounded bg-gray-100 border-l-8 border-gray-300 p-5 m-5 mx-auto text-left",
    classNameArtinya:
      "pb-3 font-semibold text-gray-900 font-mono text-sm md:text-base",
  ...
  },
  {
    ...
    classNameLatin:
      "p-3 font-Montserrat text-xs md:text-sm tracking-wide leading-7",
    latin: `Bismika robbi wadho’tu jambii, wa bika arfa’uh, fa-in amsakta
    ...
    classNameCardFaedah:
      "border-r-2 border-b-4 bg-blue-100 border-blue-300 m-4 p-5 shadow rounded w-11/12 md:w-8/12 mx-auto",
    classNameFaedahtitle: "pb-3 font-MarckScript text-base md:text-lg",
  ...
  },
  {
    ...
    classNameLatin:
      "p-3 font-Montserrat text-xs md:text-sm tracking-wide leading-7",
    latin: `Allahumma innaka kholaqta nafsii wa anta tawaffaahaa, laka
  ...
  },
  {
    ...
    classNameLatin:
      "p-3 font-Montserrat text-xs md:text-sm tracking-wide leading-7",
    latin: `Allahumma ‘aalimal ghoybi wasy syahaadah faathiros samaawaati
  ...
  },
  {
    ...
    classNameLatin:
      "p-3 font-Montserrat text-xs md:text-sm tracking-wide leading-7",
    latin: `Allahumma robbas-samaawaatis sab’i wa robbal ‘arsyil ‘azhiim,
  ...
  },
  {
    ...
    classNameLatin:
      "p-3 font-Montserrat text-xs md:text-sm tracking-wide leading-7",
    latin: `Allahumma aslamtu nafsii ilaik, wa fawwadh-tu amrii ilaik, wa
  ...
  },
  {
    ...
    classNameLatin:
      "p-3 font-Montserrat text-xs md:text-sm tracking-wide leading-7",
    latin: `Yaa Hayyu Yaa Qoyyum, bi-rohmatika as-taghiits, wa ash-lih lii
