export const ListPetang = [
  ...
  },
  {
    ...
    classNameLatin:
      "p-3 font-Montserrat text-xs md:text-sm tracking-wide leading-7",
    latin: ` Amsaynaa wa amsal mulku lillah walhamdulillah, laa ilaha
    ...
    classNameTerjemahan:
      "text-xs md:text-sm font-RobotoMono text-gray-800 italic",
    titleFaedah: "Faedah",
    terjemahan: ` “Kami telah memasuki waktu petang dan kerajaan hanya milik
  ...
  },
  {
    ...
    classNameLatin:
      "p-3 font-Montserrat text-xs md:text-sm tracking-wide leading-7",
    latin: ` Allahumma bika amsaynaa wa bika ash-bahnaa wa bika nahyaa wa
  ...
  },
  {
    ...
    classNameDzikir: "my-2 text-2xl md:text-3xl",
    dzikir: `  اَللَّهُمَّ إِنِّيْ أَمْسَيْتُ أُشْهِدُكَ وَأُشْهِدُ حَمَلَةَ
    ...
    classNameLatin:
      "p-3 font-Montserrat text-xs md:text-sm tracking-wide leading-7",
    latin: `Allahumma inni amsaytu usy-hiduka wa usy-hidu hamalata ‘arsyika
  ...
  },
  {
    ...
    classNameTerjemahan:
      "text-xs md:text-sm font-RobotoMono text-gray-800 italic",
    titleFaedah: "Faedah",
    terjemahan: `“Aku berlindung dengan kalimat-kalimat Allah yang sempurna
                  dari kejahatan makhluk yang diciptakanNya.”`,
    classNameCardFaedah:
      "border-r-2 border-b-4 bg-blue-100 border-blue-300 m-4 p-5 shadow rounded md:w-7/12 mx-auto",
    classNameFaedahtitle: "pb-3 font-MarckScript text-base md:text-lg",
    faedahnya: `Siapa yang mengucapkannya di petang hari, niscaya tidak ada
